...
backgroundImgFilePath = '3274408.jpg'
backgroundImgUrl = dash.get_asset_url(backgroundImgFilePath)

# Modify the layout to add another input field for the product code
app.layout = html.Div([
    
    html.H1("Quote Analyze Tool", style={
            "textAlign": "center",
             "marginBottom": "48px",
             "fontSize":"64px",
             "fontFamily":"Arial"
    ...
    html.Div([
        ...
        html.Div([
            html.Label("Enter Quotation:", style={
                "fontSize": "20px", 
                "display": "block", 
                # "marginBottom": "10px", 
        ...
        html.Div([
            html.Label("Enter Product Code:", style={
                "fontSize": "20px", 
                "display": "block", 
                # "marginBottom": "10px", 
                "color": "#000",
    ...
    html.Div(id='quotation-output', style={
        "marginTop": "20px", 
        "textAlign": "center", 
    }),
    ...
    dcc.Graph(id='order-histogram', style={
        ...
        "backgroundImage": "url('{}')".format(backgroundImgUrl),  # Adjust the path if necessary
                    ...
                    'data': [
                        {
                            ...
                            'name': 'Quantity',
                            'marker': {'color': 'rgba(135, 206, 250, 0.6)'},
                            'hovertemplate': "<b>Quantity:</b> %{y}M<br>"
                        },
                        {
                            'x': result['QUOTE_DATE'], 
                            'y': result['ORDER_QTY'], 
