...
class NN_CHECKVOLUMN :
    ...
    def ORDER_WEI_SUMMERIZED(self):
        ...
        self.DOUBLE_PALLETS = weight_df.loc[weight_df["inner_box_qty"] == 0, "pallet_qty"].sum()
        self.TRIPLE_PALLETS = weight_df.loc[weight_df["inner_box_qty"] > 1, "pallet_qty"].sum()
        return weight_df
