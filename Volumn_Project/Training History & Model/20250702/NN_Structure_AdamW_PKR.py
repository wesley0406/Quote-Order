...
class Neural_Network_Arch:
    ...
    def _prepare_feature_NN(self):
        ...
        # try use the packing ratio to predict the volume
        ...
        with open(rf'C:\Users\wesley\Desktop\workboard\Volumn_Project\Encode&Scaler\scaler_{today}_PKR.pkl', 'wb') as f:
            pickle.dump(self.scaler, f)
        with open(rf'C:\Users\wesley\Desktop\workboard\Volumn_Project\Encode&Scaler\target_scaler_{today}_PKR.pkl', 'wb') as f:
            pickle.dump(self.target_scaler, f)
        with open(rf'C:\Users\wesley\Desktop\workboard\Volumn_Project\Encode&Scaler\encoder_{today}_PKR.pkl', 'wb') as f:
    ...
    def _predict_container_volume(self, train=True):
        ...
        if train:
            ...
            self.model.save(rf"C:\Users\wesley\Desktop\workboard\Volumn_Project\NN_Model\Ver_{today}_Onehot_PKR.keras")
            ...
            mean_packing_ratio_test = np.mean(test_preds.flatten()) * 100
            ...
            history_df.to_excel(rf'C:\Users\wesley\Desktop\workboard\Volumn_Project\History\training_history_{today}_OnehotE_PKR.xlsx', index=False)
